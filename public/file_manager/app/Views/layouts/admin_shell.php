  ...
  <aside class="admin-sidebar" id="adminSidebar">
    <div>
      ...
      <nav class="nav-group mt-3">
        <a class="nav-item" href="/psnf/public/dashboard" style="background: rgba(99,102,241,0.08); color: #6366f1; border: 1px solid rgba(99,102,241,0.15); margin-bottom: 12px;"><i class="bi bi-arrow-left-circle-fill"></i><span>Back to ERP</span></a>
