  ...
  <section class="dash-main">
    <div class="panel card-glass p-3 mb-3">
      ...
      <div class="quick-link-list">
        <a class="quick-link-item" href="<?= preg_replace('#/file_manager/public$#', '', $app['base_url']) ?>/dashboard"><i class="bi bi-house-door"></i><span>Back to ERP Launcher</span><i class="bi bi-chevron-right"></i></a>
