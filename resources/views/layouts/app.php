        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            ...
            <div x-data="{
                ...
                <div x-show="currentModule() === 'academic'" class="space-y-1">
                    ...
                    <?php navLink('/academics/settings?tab=years', $ic['timetables'], 'Academic Years', $currentPath, $sidebarOpen); ?>
                ...
                <div x-show="currentModule() === 'payroll'" class="space-y-1" x-cloak>
                    ...
                    <?php navLink('/payroll/attendance', $ic['attendance'], 'Detailed Attendance', $currentPath, $sidebarOpen); ?>
