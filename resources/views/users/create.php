        ...
        <div class="rounded-2xl border border-slate-800/60 bg-slate-900/40 p-6 space-y-5 mb-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        <input :type="showPass ? 'text' : 'password'" name="password" required class="<?= iClass('password',$errors) ?> pr-10" placeholder="Enter password">
                ...
                <div class="space-y-1.5">
                    ...
                    <input :type="showPass ? 'text' : 'password'" name="password_confirmation" required class="<?= iClass('password_confirmation',$errors) ?>" placeholder="Repeat password">
                </div>
            </div>
